...
birthweight_data %>% 
  ...
  geom_boxplot() +
  labs(title = "birthweight vs baby’s sex") ## no effect 

birthweight_data %>% 
  ggplot(aes(x = bhead, y = bwt)) +
  geom_point() + 
  geom_smooth() +
  labs(title = "birthweight vs baby’s head circumference at birth",
       y = "birthweight",
       x = "baby's head circumference (cm)") ## strong 
  
birthweight_data %>% 
  ggplot(aes(x = blength, y = bwt)) +
  geom_point() + 
  geom_smooth() +
  labs(title = "birthweight vs baby’s length at birth (cm)",
       y = "birthweight",
       x = "baby’s length at birth (cm)") ## strong

birthweight_data %>% 
  ggplot(aes(x = delwt, y = bwt)) +
  geom_point() + 
  geom_smooth() +
  labs(title = "birthweight vs mother’s weight at delivery",
       y = "birthweight",
       x = "mother’s weight at delivery (lb)") ## week

birthweight_data %>% 
  ggplot(aes(x = fincome, y = bwt)) +
  geom_point() + 
  geom_smooth() +
  labs(title = "birthweight vs family monthly income",
       y = "birthweight",
       x = "family monthly income") ## no effect

birthweight_data %>% 
  ggplot(aes(x = frace, y = bwt)) +
  geom_boxplot() ## no effect
